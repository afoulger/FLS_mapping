...
## Purpose of project
I have completed this project for the Data Science Accelerator 2026. I used geopandas and pydeck to create my map and streamlit to create a web app. My aim was to make it easy to visualise the locations of key facilities relating to musculoskeletal health, in order to identify areas of the country with less access to facilities. I do not have specific locations of DEXA scanners but do have a count of the number of scanners in each NHS Trust, which I have aggregated to ICB and Regional level. These counts can be seen by hovering over each Region or ICB. The map is coloured based on the number of DEXA scanners per million population. I have postcodes for CDCs and NHS Trusts so these are shown as dots on the map. The user can select the ICB or Regional view and can select whether to show CDCs and/or NHS Trusts. 
