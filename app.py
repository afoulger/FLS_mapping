...
nhs_trusts_table = dl.merge_data(dexa_data_2223, nhs_trusts, 'org_name', 'dexa_count',{'dexa_count':'dexa_count_2223'})
nhs_trusts_table = dl.merge_data(dexa_data_2324, nhs_trusts_table, 'org_name', 'dexa_count',{'dexa_count':'dexa_count_2324'})
nhs_trusts_table = dl.merge_data(dexa_data_2425, nhs_trusts_table, 'org_name', 'dexa_count',{'dexa_count':'dexa_count_2425'})
...
nhs_trusts_table = dl.merge_data(fls_list_2024, nhs_trusts_table, 'nhs_trust', 'fls_service_unit', {})
...
nhs_trusts_table = dl.merge_data(cdcs, nhs_trusts_table, 'updated_nhs_trust_name', 'name_of_cdc', {})
...
nhs_trusts_table = dl.merge_data(nh_areas, nhs_trusts_table, 'associated_trust_1', 'nnhip_places', {'nnhip_places':'nnhip_places_1'})
nhs_trusts_table = dl.merge_data(nh_areas, nhs_trusts_table, 'associated_trust_2', 'nnhip_places', {'nnhip_places':'nnhip_places_2'})
nhs_trusts_table = dl.merge_data(nh_areas, nhs_trusts_table, 'associated_trust_3', 'nnhip_places', {'nnhip_places':'nnhip_places_3'})
...
nhs_trusts_table.to_csv('Outputs/nhs_trusts_table.csv', index=False)
